...
<div class="content-header">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-success">
              <div class="card-header">
                <h3 class="card-title">Pengajuan Keluhan Diterima</h3>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table 
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-danger">
              <div class="card-header">
                <h3 class="card-title">Pengajuan Keluhan Ditolak</h3>
              </div>
              <div class="card-body">
                <div class="table-responsive">
                  <table 
  ...
  <script>
    ...
    function ajaxRequestDiterima(params) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('/pengajuan/getDataDiterima'); ?>",
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: formData,
    ...
    function ajaxRequestDitolak(params) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('/pengajuan/getDataDitolak'); ?>",
        headers: {
          'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        },
        data: formData,
