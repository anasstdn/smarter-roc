...
<div class="content-header">
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            ...
            <div class="card card-primary">
              ...
              <div class="card-body">
                <?php
                if(in_array('subkriteria-create', permissions($this->session->userdata())))
                {
                  ?>
                  <div class="row">
                    <div class="col-md-11">
                ...
                <div class="table-responsive">
                  ...
                  <thead>
                    <tr>
                      <th data-field="id"></th>
                      <th data-field="sub_kriteria">Sub Kriteria</th>
                      <th data-field="rangking">Rangking</th>
  ...
  <script>
    function ajaxRequest(params) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('/subkriteria/getData'); ?>",
        headers: {
    ...
    edit = (id) => {
      save_method = 'update';
       ...
       $.ajax({
        url : "<?php echo site_url('subkriteria/edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
            ...
            $('[name="id"]').val(data.id);
            $('[name="sub_kriteria"]').val(data.sub_kriteria);
            $('[name="rangking"]').val(data.rangking);
    ...
    save = () => {
      ...
      if(save_method == 'create') {
        url = "<?php echo site_url('subkriteria/store')?>";
      } else {
        url = "<?php echo site_url('subkriteria/update')?>";
      }
      ...
      if(confirm('Apakah anda yakin akan menghapus data ini?'))
       {
        ...
        $.ajax({
          url : "<?php echo site_url('subkriteria/delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
          ...
          <form action="#" id="form" class="form-horizontal">
            ...
            <div class="form-body" style="margin-left: 2em">
              <div class="form-group">
                ...
                <div class="col-md-9">
                  <input name="sub_kriteria" placeholder="Sub Kriteria" class="form-control" type="text">
                  <span class="help-block"></span>
                </div>
              </div>
              <div class="form-group">
                <label class="control-label col-md-3">Rangking</label>
                <div class="col-md-9">
                  <input name="rangking" placeholder="Rangking" class="form-control" type="text">
                  <span class="help-block"></span>
                </div>
              </div>
            </div>
