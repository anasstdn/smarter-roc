...
<div class="content-header">
  ...
  <script>
    function ajaxRequest(params) {
      ...
      $.ajax({
        type: "POST",
        url: "<?php echo base_url('/kriteria/getData'); ?>",
        headers: {
    ...
    edit = (id) => {
      save_method = 'update';
       ...
       $.ajax({
        url : "<?php echo site_url('kriteria/edit/')?>/" + id,
        type: "GET",
        dataType: "JSON",
        success: function(data)
        {
    ...
    save = () => {
      ...
      if(save_method == 'create') {
        url = "<?php echo site_url('kriteria/store')?>";
      } else {
      ...
      if(confirm('Apakah anda yakin akan menghapus data ini?'))
       {
        ...
        $.ajax({
          url : "<?php echo site_url('kriteria/delete')?>/"+id,
          type: "POST",
          dataType: "JSON",
          success: function(data)
          {
